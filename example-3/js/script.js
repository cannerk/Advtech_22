...
//set up a counter var so that I can count how many steps mover has taken, and stop hiim after 30:
var timer_counter = 0;
onload=init;
...
function init() {
    ...
    //whener user clicks, make mover start a trip toward where mouse is (or was)
...
function moveABit(){
    ...
    mov.style.left =
        parseInt(mov.style.left) + distance_per_frame + "px";
...
/**
 * this method makes it calculate how far to
 * get to cursor, and starts the move
 * @param evt      the click event, to get cursor position
 */
